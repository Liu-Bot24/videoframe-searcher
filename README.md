...
# Image Search Gallery | 批量以图搜图

Languages: [简体中文](README.md) · [English](README-en.md)

</div>

Image Search Gallery 是一个轻量桌面工具，核心就是把本地图片快速整理进画廊，并一键批量提交给浏览器执行以图搜图。它保留了原项目成熟的本地桥接与 Chrome 插件能力，但去掉了视频下载、播放和抽帧流程，把体验收敛到更直接的批量以图搜图工作流。
...
- 批量以图搜图：从画廊多选图片，一次提交到浏览器队列执行搜索
- 图片画廊：集中展示已导入图片，方便整理和筛选待搜索图片
